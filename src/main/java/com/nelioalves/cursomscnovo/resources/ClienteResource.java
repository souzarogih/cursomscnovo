...
public class ClienteResource {
	...
	/*Método para insert de um novo Cliente*/
	...
	/*Método para alterar uma Cliente*/
	...
	/*Método para deletar uma Cliente*/
	...
	/*Método de consulta todas as Cliente no endpoint*/
	@PreAuthorize("hasAnyRole('ADMIN')")
	...
	/*Método de paginação*/
	@RequestMapping(value="/page",method=RequestMethod.GET)//Informa que é um metódo do tipo GET
	...
	/*Método para enviar a foto do usuário*/
