...
import com.nelioalves.cursomscnovo.dto.ProdutoDTO;
import com.nelioalves.cursomscnovo.resources.utils.URL;
import com.nelioalves.cursomscnovo.services.ProdutoService;

@RestController//Diretiva do Spring Boot
@RequestMapping(value="/produtos")//Endpoint Rest que será usado.
